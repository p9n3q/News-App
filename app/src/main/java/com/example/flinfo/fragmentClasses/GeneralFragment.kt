...
import com.example.flinfo.utils.Constants.TOP_HEADLINES_COUNT
import com.example.flinfo.utils.Constants.INITIAL_POSITION
    ...
    override fun onCreateView(
            ...
            setCarouselViewListener { view, position ->
                ...
                view.setOnClickListener {
                    ...
                    val intent = Intent(context, ReadFlinfoNewsActivity::class.java).apply {
                        putExtra(NEWS_UUID, newsDataForTopHeadlines[position].uuid)
        ...
        adapter.setOnItemClickListener(object : CustomAdapter.OnItemClickListener {
            override fun onItemClick(position: Int) {
                val intent = Intent(context, ReadFlinfoNewsActivity::class.java).apply {
                    putExtra(NEWS_UUID, newsDataForDown[position].uuid)
