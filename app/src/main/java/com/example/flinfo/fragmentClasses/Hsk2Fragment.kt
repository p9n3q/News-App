...
class Hsk2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hsk2, container, false)
        ...
        viewModel.getHskNews("mandarin", "hsk2")?.observe(viewLifecycleOwner, { newsList ->
            newsData.clear()
